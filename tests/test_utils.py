    ...
    with patch("app.utils.agent_utils.analyze_user_input") as mock_analyze:
        ...
        mock_analyze.return_value = {
            ...
            "menu_items": [
                ...
                {"name": "Miso Soup", "quantity": 1, "modifier": []},
            ],
        }
...
def test_build_order_description():
    ...
    # Simple order
    order1 = [{"name": "California Roll", "quantity": 2}]
    ...
    order2 = [
        {
            ...
            "quantity": 1,
            "modifier": [{"name": "Spicy Mayo", "quantity": 1}],
        }
    ]
    ...
    order3 = [
        {
            "name": "California Roll",
            "quantity": 2,
            "modifier": [{"name": "Spicy Mayo", "quantity": 2}],
        },
...
def test_calculate_bill_amount(app):
    ...
    with app.test_request_context():
        # Simple order
        order1 = [{"name": "California Roll", "quantity": 2, "price": 9.95}]
        ...
        order2 = [
            {
                ...
                "quantity": 1,
                "price": 9.95,
                "modifier": [{"name": "Spicy Mayo", "quantity": 1, "price": 0.50}],
            }
        ]
...
def test_calculate_bill_amount_with_tax(app):
    ...
    with app.test_request_context():
        ...
        with patch(
            "app.utils.order_utils.calculate_bill_amount", wraps=calculate_bill_amount
        ) as mock_calc:

            # Create a simple order
            order = [{"name": "California Roll", "quantity": 2, "price": 10.00}]
    ...
    with app.app_context():
        ...
        with patch("app.utils.order_utils.find_menu_item") as mock_find:
            ...
            mock_find.return_value = (
                {"name": "California Roll", "price": 9.95, "available": True},
            ...
            mock_find.return_value = (
                {"name": "Spicy Tuna Roll", "price": 11.95, "available": True},
