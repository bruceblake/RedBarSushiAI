...
def test_order_with_special_requests(api_request, create_test_menu_payload):
    ...
    special_request_acknowledged = any(phrase in special_twiml.lower() for phrase in 
                                     ["special", "allergy", "gluten", "request", "dietary"])
    assert special_request_acknowledged, "System didn't acknowledge special dietary request"
