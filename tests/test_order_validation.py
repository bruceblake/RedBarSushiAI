...
from app.utils.order_utils import validate_order_items, validate_modifiers, prepare_order_for_deliverect
...
def test_prepare_order_for_deliverect():
    ...
    with patch('app.utils.order_utils.validate_order_items') as mock_validate_items, \
        ...
        validated_with_mods = [{"name": "Test Item", "reference_handler": "TEST-1", "modifier": [{"name": "Test Mod", "reference_handler": "MOD-1"}]}]
