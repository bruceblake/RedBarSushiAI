...
def test_modifier_structure_preservation(flask_client):
    ...
    assert modifiers['MOD-1']['price'] == 199 or modifiers['MOD-1']['price'] == 1.99  # Depending on price format
...
def test_modifier_update(flask_client):
            ...
            "items": [
                {
                    ...
                    "price": 1099,
                    "available": True,
                    "modifierGroups": ["BURG-MOD-1", "BURG-MOD-2"]  # Added a new modifier group
                }
            ],
            "modifierGroups": [
                {
                    ...
                    "modifiers": ["BURG-OPT-1", "BURG-OPT-2", "BURG-OPT-3", "BURG-OPT-4"]  # Added new modifier
                },
                {
                    "id": "BURG-MOD-2",
    ...
    assert set(modifier_groups['BURG-MOD-2']['modifiers']) == set(['BURG-OPT-5', 'BURG-OPT-6', 'BURG-OPT-7'])
