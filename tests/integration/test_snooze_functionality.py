...
def test_snooze_unsnooze_with_correct_format(flask_client, simple_menu_format):
    ...
    updated_steak_item = next((i for i in updated_menu_data['items'] if i['plu'] == 'STK-01'), None)
...
def test_snooze_without_allSnoozedItems(flask_client, simple_menu_format):
    ...
    assert snooze_response.status_code in [200, 400, 500]  # Some implementations may reject this format
