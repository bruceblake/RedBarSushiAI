...
class ConversationScenario:
    ...
    def __init__(
        self, name, description, turns, expected_order=None, expected_intent=None
    ):
        """
...
SCENARIOS = [
    ConversationScenario(
        ...
        expected_order=[{"name": "California Roll", "quantity": 1, "price": 7.95}],
    ...
    ConversationScenario(
        ...
        turns=[
            ...
            ("How much is the Spicy Tuna Roll?", "The Spicy Tuna Roll is $8.95"),
            (
    ...
    ConversationScenario(
        ...
        turns=[
            ...
            ("No, that's all", "Your order comes to a total of"),
        ],
        expected_order=[
    ...
    ConversationScenario(
        ...
        expected_order=[{"name": "Spicy Tuna Roll", "quantity": 1, "price": 8.95}],
        expected_intent="order_food",
    ),
    ConversationScenario(
        name="out_of_stock",
...
class TestCustomerInteractions:
    ...
    def test_scenario(self, mock_load_menu_data, scenario, sample_menu, monkeypatch):
        ...
        pytest.skip(
            "Simulation tests require extensive mocking and are fragile. Run manually when needed."
        )
        ...
        try:
            ...
            pytest.skip(
                "Required module app.utils.realtime_audio could not be imported"
            )
        ...
        process_chunk(
            user_input, conversation_state["session_id"], callback=collect_response
        )
        ...
        assert "text" in conversation_state["responses"][0] or isinstance(
            conversation_state["responses"][0], str
        )
