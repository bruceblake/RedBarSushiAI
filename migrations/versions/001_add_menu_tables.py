...
def upgrade():
    ...
    properties_column = (
        ...
        if dialect == "postgresql" and has_jsonb
        else sa.Column("properties", sa.Text)
    )
    ...
    op.create_index(
        "ix_menu_items_reference_handler", "menu_items", ["reference_handler"]
    )
    ...
    op.create_index(
        "ix_menu_modifiers_reference_handler", "menu_modifiers", ["reference_handler"]
    )
    ...
    op.create_index(
        "ix_menu_modifier_groups_reference_handler",
        "menu_modifier_groups",
        ["reference_handler"],
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["menu_modifier_group_id"], ["menu_modifier_groups.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["menu_modifier_id"], ["menu_modifiers.id"], ondelete="CASCADE"
        ),
