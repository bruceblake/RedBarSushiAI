...
def main_menu():
    ...
    if choice == 'order' and channel_status == 1:
        ...
        with response.gather(
            ...
            g.say("You can ask for the menu, prices, descriptions, or say what you'd like to order.")
        ...
        with response.gather(
            ...
            g.say("I didn’t understand. Press 1 to order, 2 for menu questions, 3 for a real person.")
    return Response(str(response), mimetype='text/xml')
