...
def sanitize_properties(
    props: Union[Dict[str, Any], str, None],
...
item_modifier_group = Table(
    ...
    Column(
        "modifier_group_id", Integer, ForeignKey("modifier_groups.id"), primary_key=True
    ),
)
...
group_modifier = Table(
    ...
    Column(
        "menu_modifier_id", Integer, ForeignKey("menu_modifiers.id"), primary_key=True
    ),
)
...
class MenuCategory(BaseModel):
    ...
    # sub_categories relationship removed as flagged by Vulture
...
class MenuModifierGroup(BaseModel):
    ...
    modifiers = relationship(
        "MenuModifier", secondary=group_modifier, back_populates="groups"
    )
    items = relationship(
        "MenuItem", secondary=item_modifier_group, back_populates="modifier_groups"
    )
...
class MenuModifier(BaseModel):
    ...
    # Relationships
    groups = relationship(
        "MenuModifierGroup", secondary=group_modifier, back_populates="modifiers"
    )
...
class MenuItem(BaseModel):
    ...
    modifier_groups = relationship(
        "MenuModifierGroup", secondary=item_modifier_group, back_populates="items"
    )
