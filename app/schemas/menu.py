...
from pydantic import BaseModel  # root_validator removed
...
class MenuCategoryResponse(MenuCategoryBase):
    ...
    # class Config: # Removed orm_mode as per Vulture
    #     orm_mode = True
...
class SnoozeRequest(BaseModel):
    ...
    # Validator duration_must_be_positive removed as per Vulture
