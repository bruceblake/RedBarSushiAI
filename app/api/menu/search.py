...
# from pydantic import BaseModel # Moved up
# from datetime import datetime # Removed as SearchResult is removed
...
async def search_menu(
    ...
    include_categories: bool = Query(
        True, description="Include categories in search results"
    ),
    include_modifiers: bool = Query(
        True, description="Include modifiers in search results"
    ),
    include_variants: bool = Query(
        True, description="Include variants in search results"
    ),
