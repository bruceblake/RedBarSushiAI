...
OPENAI_API_KEY = os.getenv(
    "OPENAI_API_KEY",
    "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",
)
...
STRIPE_API_KEY = os.getenv(
    "STRIPE_API_KEY",
    "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",
)
...
DELIVERECT_CLIENT_SECRET = os.getenv(
    "DELIVERECT_CLIENT_SECRET", "byOTwZy7CvhgFgQBuvdGVZVcWoxlfTj1"
)
DELIVERECT_API_URL = os.getenv(
    "DELIVERECT_API_URL",
    "https://api.staging.deliverect.com/nextgen/order/66e88f33475a66c53e90e62b",
)
...
elif os.environ.get("RENDER", "").lower() == "true" or os.environ.get(
    "RENDER_SERVICE_ID"
):
    # Use Render-specific URL
    BASE_URL = "https://redbarsushiai.onrender.com"
elif not os.environ.get(
    "DISABLE_PYTHONANYWHERE_DETECTION", ""
).lower() == "true" and any(
    path.endswith("pythonanywhere-services.com")
    for path in [default_uri, pythonanyhere_uri or ""]
):
