...
# -*- coding: utf-8 -*-
"""
Enhanced MCP Server with Fixed SSE implementation for RedBarSushiAI testing.
...
# Set up logging
logging.basicConfig(
    level=logging.DEBUG,  # Use DEBUG for more verbose logging
...
# MCP protocol version - should match what Claude expects
...
class EnhancedMCPServer:
    ...
    def create_jsonrpc_notification(self, method: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    async def handle_initialize(self, request_id: Union[str, int], params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Received initialize request: protocol={client_protocol_version}, capabilities={client_capabilities}, client={client_info}")
...
def mcp_sse_endpoint():
    ...
    def stream():
        ...
        while True:
            ...
            time.sleep(5)  # 5 second ping interval for more responsiveness
